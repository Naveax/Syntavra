...
def extract_yaml_python_block(text: str) -> str:
    ...
    # Strip only the YAML block indentation from actual Python source lines.
    # Do not textwrap.dedent(): embedded triple-quoted YAML/JSON bodies may
    # intentionally have smaller indentation and would pin the common margin.
    prefix = ' ' * 10
    raw = lines[start:end]
