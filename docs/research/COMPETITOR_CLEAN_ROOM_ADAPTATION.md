...
SignalCore's adaptive-context work was designed from publicly documented behavior and independently implemented against SignalCore's own exact-evidence, SQLite/WAL and claim-governance primitives. No competitor source file is vendored or imported.

## Provenance and license boundary

| Project | Public license at review time | Behavior studied | SignalCore implementation decision |
|---|---|---|---|
...
| Volt / LCM | MIT | Immutable history, summary lineage and exact expansion | Adaptive capture events attach to SignalCore sessions; no Volt database/runtime code used |
