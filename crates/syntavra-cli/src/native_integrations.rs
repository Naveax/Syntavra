...
const PROVIDERS: [IntegrationSpec; 10] = [
    IntegrationSpec {
        ...
        install_mode: "proxy-or-sdk",
        capabilities: &["stream", "usage", "cache", "tools"],
    },
    IntegrationSpec {
    ...
    IntegrationSpec {
        ...
        install_mode: "proxy-or-sdk",
        capabilities: &["stream", "usage", "tools"],
    },
    IntegrationSpec {
...
const FRAMEWORKS: [IntegrationSpec; 15] = [
    IntegrationSpec {
        integration_id: "openai-python",
        family: "framework",
        transport: "sdk",
        install_mode: "python-wrapper",
        capabilities: &["sync", "async", "stream"],
    },
    IntegrationSpec {
        integration_id: "openai-node",
        family: "framework",
        transport: "sdk",
        install_mode: "typescript-wrapper",
        capabilities: &["async", "stream"],
    },
    IntegrationSpec {
        integration_id: "anthropic-python",
        family: "framework",
        transport: "sdk",
        install_mode: "python-wrapper",
        capabilities: &["sync", "async", "stream"],
    ...
    IntegrationSpec {
        integration_id: "vercel-ai-sdk",
        family: "framework",
        transport: "middleware",
        install_mode: "typescript-middleware",
    ...
    IntegrationSpec {
        ...
        family: "framework",
        transport: "callback",
        install_mode: "python-callback",
        capabilities: &["providers", "usage", "cache"],
    },
    IntegrationSpec {
        ...
        transport: "callback",
        install_mode: "python-callback",
        capabilities: &["events", "usage", "tools"],
    },
    IntegrationSpec {
        integration_id: "langgraph",
        family: "framework",
        transport: "middleware",
        install_mode: "python-middleware",
        capabilities: &["state", "events", "tools"],
    },
    IntegrationSpec {
        integration_id: "agno",
        family: "framework",
        transport: "adapter",
        install_mode: "python-adapter",
        capabilities: &["agents", "usage", "tools"],
    },
    IntegrationSpec {
        integration_id: "strands",
        family: "framework",
        transport: "adapter",
        install_mode: "python-adapter",
        capabilities: &["agents", "usage", "tools"],
    ...
    IntegrationSpec {
        ...
        transport: "middleware",
        install_mode: "python-middleware",
        capabilities: &["http", "stream"],
    },
    IntegrationSpec {
        integration_id: "openclaw",
        family: "framework",
        transport: "context-engine",
        install_mode: "plugin",
        capabilities: &["memory", "tools", "stream"],
    },
    IntegrationSpec {
        integration_id: "mcp",
        family: "framework",
    ...
    IntegrationSpec {
        ...
        install_mode: "zero-code",
        capabilities: &["providers", "stream", "usage"],
    },
];
...
const HOSTS: [IntegrationSpec; 18] = [
    IntegrationSpec {
        ...
        family: "host",
        transport: "plugin+hooks",
        install_mode: "auto",
        capabilities: &["session", "pre-tool", "post-tool", "compact"],
    },
    IntegrationSpec {
        ...
        transport: "skill+mcp",
        install_mode: "auto",
        capabilities: &["session", "tools", "mcp"],
    },
    IntegrationSpec {
        integration_id: "gemini-cli",
        family: "host",
        transport: "extension+mcp",
        install_mode: "auto",
        capabilities: &["session", "tools", "mcp"],
    },
    IntegrationSpec {
        integration_id: "vscode-copilot",
        family: "host",
        transport: "instructions+mcp",
        install_mode: "auto",
        capabilities: &["instructions", "tools", "mcp"],
    },
    IntegrationSpec {
        integration_id: "jetbrains-copilot",
        family: "host",
        transport: "instructions+mcp",
        install_mode: "auto",
        capabilities: &["instructions", "tools", "mcp"],
    ...
    IntegrationSpec {
        ...
        transport: "rules+mcp",
        install_mode: "auto",
        capabilities: &["rules", "tools", "mcp"],
    },
    IntegrationSpec {
        integration_id: "windsurf",
        family: "host",
        transport: "rules+mcp",
        install_mode: "auto",
        capabilities: &["rules", "tools", "mcp"],
    ...
    IntegrationSpec {
        integration_id: "qwen-code",
        family: "host",
        transport: "agents+mcp",
        install_mode: "auto",
        capabilities: &["session", "tools", "mcp"],
    },
    IntegrationSpec {
    ...
    IntegrationSpec {
        ...
        transport: "plugin",
        install_mode: "auto",
        capabilities: &["session", "memory", "tools"],
    },
    IntegrationSpec {
        integration_id: "aider",
        family: "host",
        transport: "env+wrapper",
        install_mode: "auto",
        capabilities: &["session", "repository"],
    },
    IntegrationSpec {
        integration_id: "continue",
        family: "host",
        transport: "rules+mcp",
        install_mode: "auto",
        capabilities: &["rules", "tools", "mcp"],
