...
// Reuse the exact Remaining-71 family modules for lower-owner discovery.
// The route identities still come exclusively from the parser-derived report;
// this audit does not maintain a second 71-route table.
