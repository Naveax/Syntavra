...
class CapabilityTokenIssuer:
    ...
    def __init__(self, key: bytes, *, issuer: str = "syntavra-local", clock_skew_seconds: int = 30):
        if len(key) < 32:
    ...
    @classmethod
    def from_environment(cls, name: str = "SYNTAVRA_CONTROL_SIGNING_KEY_B64") -> "CapabilityTokenIssuer":
