...
class ToolDefinition:
    ...
    def catalog_entry(self) -> dict[str, Any]:
        return {
            ...
            "annotations": {
                "syntavra/version": self.version,
                "syntavra/permissions": list(self.permissions),
                "syntavra/timeout_seconds": self.timeout_seconds,
                "syntavra/cost_budget": self.cost_budget,
                "syntavra/sandbox_profile": self.sandbox_profile,
                "syntavra/approval_required": self.approval_required,
                "syntavra/deprecated": self.deprecated,
                "syntavra/replacement": self.replacement,
            },
        }
...
class MCPToolRegistry:
    ...
    def register(self, definition: ToolDefinition) -> None:
        if not definition.name.startswith("syntavra.") or definition.name in self._tools:
