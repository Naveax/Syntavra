...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="syntavra",
        description="Syntavra R21 engine selector and safe read-only router",
    )
...
def main(
    ...
    *,
    ...
    router: ReadOnlyCommandRouterR21 | None = None,
) -> int:
    ...
    active_router = router or ReadOnlyCommandRouterR21(
        active,
