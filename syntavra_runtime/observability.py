...
_current_trace: contextvars.ContextVar["TraceContext | None"] = contextvars.ContextVar("syntavra_trace", default=None)
...
class MetricsRegistry:
    ...
    def _metric_name(value: str) -> str:
        return "syntavra_" + "".join(ch if ch.isalnum() or ch == "_" else "_" for ch in value).strip("_")
...
class Observability:
    def __init__(self, root: Path, *, service: str = "syntavra", sample_rate: float = 1.0):
