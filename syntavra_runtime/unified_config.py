...
class ConfigManager:
    ...
    def __init__(
        ...
        *,
        ...
        env_prefix: str = "SYNTAVRA_CFG__",
    ):
        self.project_root = Path(project_root).resolve(strict=False)
        self.state_root = Path(state_root).resolve(strict=False)
        self.user_config = user_config or Path.home() / ".config" / "syntavra" / "config.toml"
        self.project_config = project_config or self.project_root / ".syntavra" / "config.toml"
