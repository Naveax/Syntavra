...
1. Pair once with SignalCore and provision a private local pairing key.
...
SignalCore verifies the signature, Studio host/transport, process identity, Place
...
secret or modify SignalCore's source. Stronger local-adversary resistance requires
