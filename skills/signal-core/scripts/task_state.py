...
EXCLUDED = {".git", ".signalcore", "node_modules", "target", "dist", "build", "vendor", ".venv", "venv", "__pycache__"}
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Encode SignalCore task/repository/session state")
