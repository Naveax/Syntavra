...
def compare_results(
    ...
    *,
    ...
    for base in baseline:
        ...
        if not sig:
            invalid.append({"repetition": base.repetition, "reason": "missing-signalcore-arm"})
            continue
    ...
    return {
        ...
        "diagnostics": {
            ...
            "signalcore_wait_calls": sum(sig.wait_calls for _, sig in valid_pairs),
