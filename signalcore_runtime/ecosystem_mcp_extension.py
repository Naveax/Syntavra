...
def install() -> None:
    ...
    if getattr(MCPServer, "_signalcore_ecosystem_extension_v4", False):
        return
    ...
    def extended_call_tool(self: Any, name: str, arguments: dict[str, Any]) -> Any:
        if name == "signalcore.ecosystem.capabilities":
            return {
    ...
    MCPServer._signalcore_ecosystem_extension_v4 = True
