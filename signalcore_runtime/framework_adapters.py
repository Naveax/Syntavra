...
class LangChainCallbackHandler:
    ...
    normal LangChain execution path; SignalCore only observes evidence and usage.
    """
...
def framework_capabilities() -> dict[str, Any]:
    ...
    return {
        ...
        "dependency_policy": "optional provider/framework SDKs are never imported by SignalCore",
    }
