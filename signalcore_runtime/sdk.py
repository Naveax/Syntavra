...
class SignalCoreClient:
    """Dependency-free SDK facade around SignalCore's exact provider gateway.

    The caller supplies the provider SDK transport. SignalCore owns request
