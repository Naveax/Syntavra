...
class StateBackupManager:
    ...
    def create(self, destination: Path, *, encrypt: bool = True) -> BackupResult:
        ...
        with tempfile.TemporaryDirectory(prefix="signalcore-backup-") as temp_name:
    ...
    def verify(self, source: Path, *, encrypted: bool = True) -> dict[str, Any]:
        with tempfile.TemporaryDirectory(prefix="signalcore-verify-") as temp_name:
    ...
    def restore(self, source: Path, *, encrypted: bool = True, dry_run: bool = True) -> dict[str, Any]:
        ...
        with tempfile.TemporaryDirectory(prefix="signalcore-restore-") as temp_name:
            temp = Path(temp_name)
